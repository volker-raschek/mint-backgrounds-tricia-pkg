...
![AUR version](https://img.shields.io/aur/version/mint-backgrounds-tricia?label=AUR)
[![Build Status](https://drone.cryptic.systems/api/badges/volker.raschek/mint-backgrounds-tricia-pkg/status.svg)](https://drone.cryptic.systems/volker.raschek/mint-backgrounds-tricia-pkg)
![AUR votes](https://img.shields.io/aur/votes/mint-backgrounds-tricia)

This repository contains build files to build the Arch Linux package `mint-backgrounds-tricia`. Instead of building the
...
```bash
git clone https://aur.archlinux.org/mint-backgrounds-tricia.git
cd mint-backgrounds-tricia
makepkg
```
...
```bash
yay --sync --aur mint-backgrounds-tricia
```
...
sudo pacman --sync mint-backgrounds-tricia
```
